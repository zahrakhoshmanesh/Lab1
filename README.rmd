...
Git hub account that allow us to knit the index.Rmd file. Generally, there was not a big problem that 
stopped from solving the problem. We followed the instructions that given on the lab page and tried 
to receive the html version of the book by installing all packages that require index.Rmd file.
